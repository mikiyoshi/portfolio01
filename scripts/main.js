...
class Main {
  constructor() {
    ...
    this._observers = []; // this.#observers = [] 最新版は # を使えるが、# は class 内のみ有効
    this._init();
  }

  _init() {
    new MobileMenu();
    Pace.on('done', this._scrollInit.bind(this)); // this is to start at the end of page lading
  }
